...
const AthleteRegistration = () => {
    ...
    const handleCheckboxChange = (e) => {
        ...
        setAthleteInformation((prevAthleteInfo) => ({
            ...prevAthleteInfo,
            disclaimerCheckbox: e.target.checked,
        }));
    }
    console.log('Checkbox:', isCheckboxChecked)

    const handleCheckboxSubmit = () => {
        if (athleteInformation.disclaimerCheckbox) {
            console.log('Successfully proceeded to next page')
        } else {
    ...
    return(
        <div className="form" >
            ...
            <button onClick={(e) => { handleAthleteSubmit(e); handleCheckboxSubmit(); }}>Post To The Backend</button>
